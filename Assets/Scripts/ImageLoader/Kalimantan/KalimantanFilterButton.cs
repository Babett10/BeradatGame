...
public class KalimantanFilterButton : MonoBehaviour
{
    ...
    public KalimantanImageLoader imageLoader;
        ...
        FirebaseApp.CheckAndFixDependenciesAsync().ContinueWithOnMainThread(task =>
        {
            if (task.IsCompleted)
            {
                ...
                foreach (Button button in filterButtons)
                {
                    ...
                    button.onClick.AddListener(() => FilterByProvinceKalimantan(provinceName));
                }
    ...
    void FilterByProvinceKalimantan(string province)
    {
        databaseReference.Child("BajuAdat").Child("Kalimantan").GetValueAsync().ContinueWithOnMainThread(dbTask =>
        {
