...
public class SumateraFilterButton : MonoBehaviour
{
    ...
    public SumateraImageLoader imageLoader;
        ...
        FirebaseApp.CheckAndFixDependenciesAsync().ContinueWithOnMainThread(task =>
        {
            if (task.IsCompleted)
            {
                ...
                foreach (Button button in filterButtons)
                {
                    ...
                    button.onClick.AddListener(() => FilterByProvinceSumatera(provinceName));
                }
    ...
    void FilterByProvinceSumatera(string province)
    {
